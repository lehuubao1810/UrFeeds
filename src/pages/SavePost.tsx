...
export default function SavePost() {
  ...
  useEffect(() => {
    if (isAuthenticated) {
      dispatch(getSavePostFromFirestore(user?.uid));
    }
  ...
  return (
    <>
      ...
      {savePost.posts.length !== 0 ? (
                ...
                <ul className="font-medium flex">
                  <li>
                    <div
                      ...
                      className="cursor-pointer sm:flex-col flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                    >
                      <svg
                  ...
                  <li>
                    ...
                    >
                      <svg
                        className="flex-shrink-0 w-8 h-8 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-white"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 576 512"
                        fill="currentColor"
                      >
                ...
                {savePost.posts.map((post) => (
                  <li className="border-b-2 p-4 hover:bg-gray-50 cursor-pointer">
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="text-lg mb-4 inline-block font-medium text-gray-900 dark:text-gray-100 hover:text-blue-500 dark:hover:text-blue-400"
                    >
                      {post.title}
                    </a>
                    {/* <p
        ...
        <div className="flex justify-center text-lg font-bold mt-8">
          Don't have any saved posts!
        </div>
      )}
    </>
  );
