...
export default function AddFeedPage() {
  ...
  return (
    <div className="w-full">
      <h1 className="text-2xl font-bold text-gray-800 dark:text-white text-center mt-4 mb-16">
        Add feeds
      </h1>
      <div className="flex justify-around mb-16">
        <Link
          to={"/add/rss"}
          className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group border-2 cursor-pointer"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
            className="w-10 h-10 text-blue-600 dark:text-gray-400 mx-auto"
            fill="currentColor"
          >
        ...
        <Link
          to={"/add/import"}
          className="flex items-center p-4 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group border-2 cursor-pointer"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
            className="w-10 h-10 text-yellow-600 dark:text-gray-400 mx-auto "
            fill="currentColor"
          >
